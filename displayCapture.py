...
ty = face.load_image_file('IMG_0403.jpg')
ty_encoding = face.face_encodings(ty)[0]
known_face_encodings = [ty_encoding]
known_face_names = ['ty']
...
while True:
    ...
    for (top,right,bottom,left), name in zip(face_locations,face_names):
        ...
        cv2.rectangle(frame,(left,top - 35 ), (right,bottom), (0,0,255),cv2.FILLED)
